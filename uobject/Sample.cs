...
public class GameManager : MonoBehaviour {
    ...
    private UObject _drone;
    //private Console _console;
    private GameObject _blade_front_left;
    private GameObject _blade_front_right;
    private GameObject _blade_back_left;
    private GameObject _blade_back_right;
    private bool _isON = false;
    private float _powerL = 1.0f;
    private float _powerR = 1.0f;
    ...
    void Update () {
        ...
        if (_oqt.IsLIndexTriggerDown) {
            _powerL = (float)(1.0f + _oqt.LIndexTrigger);
        }

        if (_oqt.IsLThumbstickUpDown) { //上昇（左↑）
            _isON = true;
            if (_isON) _drone.UseGravity = false;
            _drone.MoveY(0.01f*_powerL);
        }

        // if (_oqt.IsLThumbstickUpDown) { //上昇（左↑）
        //     _isON = true;
        //     if (_isON) _drone.GetComponent<Rigidbody>().useGravity = false;
        //     _drone.transform.Translate(0, 0.01f*_powerL, 0);
        //     //ブレード回転
        //     _blade_front_left.transform.Rotate(new Vector3(0, 0, 44f*_powerR));
        //     _blade_front_right.transform.Rotate(new Vector3(0, 0, -44f*_powerR));
        //     _blade_back_left.transform.Rotate(new Vector3(0, 0, -44f*_powerR));
        //     _blade_back_right.transform.Rotate(new Vector3(0, 0, 44f*_powerR));
        //     //角度
        //     float _rotationY = _drone.transform.localEulerAngles.y; //現在の角度
        //     //_console.Log(_rotationY.ToString());
        //     _drone.transform.eulerAngles = new Vector3(0, _rotationY, 0);

        // } else if (_oqt.IsLThumbstickDownDown) { //下降（左↓）
        //     _drone.transform.Translate(0, -0.01f*_powerL, 0);
        //     //ブレード回転
        //     _blade_front_left.transform.Rotate(new Vector3(0, 0, 17f*_powerR));
        //     _blade_front_right.transform.Rotate(new Vector3(0, 0, -17f*_powerR));
        //     _blade_back_left.transform.Rotate(new Vector3(0, 0, -17f*_powerR));
        //     _blade_back_right.transform.Rotate(new Vector3(0, 0, 17f*_powerR));
        //     //角度
        //     float _rotationY = _drone.transform.localEulerAngles.y; //現在の角度
        //     _drone.transform.eulerAngles = new Vector3(0, _rotationY, 0);

        // } else if (_oqt.IsLThumbstickLeftDown) { //左旋回（左←）
        //     _drone.transform.Rotate(new Vector3(0, -1*_powerL, 0));
        //     //ブレード回転
        //     _blade_front_left.transform.Rotate(new Vector3(0, 0, 34f*_powerR));
        //     _blade_front_right.transform.Rotate(new Vector3(0, 0, -17f*_powerR));
        //     _blade_back_left.transform.Rotate(new Vector3(0, 0, -17f*_powerR));
        //     _blade_back_right.transform.Rotate(new Vector3(0, 0, 34f*_powerR));

        // } else if (_oqt.IsLThumbstickRightDown) { //右旋回（左→）
        //     _drone.transform.Rotate(new Vector3(0, 1*_powerL, 0));
        //     //ブレード回転
        //     _blade_front_left.transform.Rotate(new Vector3(0, 0, 17f*_powerR));
        //     _blade_front_right.transform.Rotate(new Vector3(0, 0, -34f*_powerR));
        //     _blade_back_left.transform.Rotate(new Vector3(0, 0, -34f*_powerR));
        //     _blade_back_right.transform.Rotate(new Vector3(0, 0, 17f*_powerR));
...
public class GameManager : MonoBehaviour {
    ...
    void Start() {
        ...
        _blade_front_left = _drone.transform.Find("blade_front_left").gameObject;
        _blade_front_right = _drone.transform.Find("blade_front_right").gameObject;
        _blade_back_left = _drone.transform.Find("blade_back_left").gameObject;
        _blade_back_right = _drone.transform.Find("blade_back_right").gameObject;
    }
    ...
    void Update () {
        ...
        //====================================
        if (_oqt.IsLIndexTriggerDown) {
            _powerL = (float)(1.0f + _oqt.LIndexTrigger); //*1.5); //1.0-2.5
            //_console.Log(_powerL.ToString());
        }
        ...
        if (_oqt.IsRIndexTriggerDown) {
            _powerR = (float)(1.0f + _oqt.RIndexTrigger); //*1.5); //1.0-2.5
        }

        if (_oqt.IsRThumbstickUpDown) { //前進（右↑）
            _drone.transform.Translate(0, 0, 0.01f*_powerR);
            //ブレード回転
            _blade_front_left.transform.Rotate(new Vector3(0, 0, 17f*_powerR));
            _blade_front_right.transform.Rotate(new Vector3(0, 0, -17f*_powerR));
            _blade_back_left.transform.Rotate(new Vector3(0, 0, -34f*_powerR));
            ...
            //角度
            float _rotationY = _drone.transform.localEulerAngles.y; //現在の角度
            _drone.transform.eulerAngles = new Vector3(1, _rotationY, 0);
            ...
            _drone.transform.Translate(-0.01f*_powerR, 0, 0);
            //ブレード回転
            _blade_front_left.transform.Rotate(new Vector3(0, 0, 17f*_powerR));
            _blade_front_right.transform.Rotate(new Vector3(0, 0, -34f*_powerR));
            _blade_back_left.transform.Rotate(new Vector3(0, 0, -17f*_powerR));
            _blade_back_right.transform.Rotate(new Vector3(0, 0, 34f*_powerR));
            //角度
            //_drone.transform.rotation = Quaternion.Euler(0.0f, 0.0f, 5.0f);
            //角度
            float _rotationY = _drone.transform.localEulerAngles.y; //現在の角度
            _drone.transform.eulerAngles = new Vector3(0, _rotationY, 1);
            ...
            if (_isON) {
                //ブレード回転
                _blade_front_left.transform.Rotate(new Vector3(0, 0, 17f));
                _blade_front_right.transform.Rotate(new Vector3(0, 0, -17f));
                _blade_back_left.transform.Rotate(new Vector3(0, 0, -17f));
                _blade_back_right.transform.Rotate(new Vector3(0, 0, 17f));
                //角度
                float _rotationY = _drone.transform.localEulerAngles.y; //現在の角度
                _drone.transform.eulerAngles = new Vector3(0, _rotationY, 0);
            }
...
/*******************************************************************************
// イベントハンドラの登録（左用）
_oqt.LThumbstickUpDown += LThumbstickUpDownHandler; //左↑
_oqt.LThumbstickDownDown += LThumbstickDownDownHandler; //左↓
_oqt.LThumbstickLeftDown += LThumbstickLeftDownHandler; //左←
_oqt.LThumbstickRightDown += LThumbstickRightDownHandler; //左→

// イベントハンドラの登録（右用）
_oqt.RThumbstickUpDown += RThumbstickUpDownHandler; //右↑
_oqt.RThumbstickDownDown += RThumbstickDownDownHandler; //右↓
_oqt.RThumbstickLeftDown += RThumbstickLeftDownHandler; //右←
_oqt.RThumbstickRightDown += RThumbstickRightDownHandler; //右→
...
public class GameManager : MonoBehaviour {
    ...
    void Start() {
        ...
        _oculusTouchL = "OculusTouchL";
        _oculusTouchR = "OculusTouchR";
        ForDummy(); //ダミーのあれこれ
