# OQtouch リファレンスマニュアル
Version Alpha 7 (20191105.1846) 対応  
© 2019 夢寐郎
...
### ◇ 説明
プロパティ。  
「左人差し指トリガーを押しているトリガー量」（0〜1 まで小数点以下15桁表示、double 型）。読み取り専用。  
...
### ◇ 説明
プロパティ。  
「右人差し指トリガーを押しているトリガー量」（0〜1 まで小数点以下15桁表示、double 型）。読み取り専用。  
